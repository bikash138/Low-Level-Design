...
//So here we have introduced a abstract class that will handle the db save method.
//High level module will depend on this abstract class.
//And abstract class will be responsible to implement the save method to lower level modules.
